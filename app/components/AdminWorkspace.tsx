...
const emptyContent = (): ContentItem => ({ kind: "case_article", status: "published", access_level: "public", is_teaching: false, title: "", slug: "", summary: "", level: "Clinical education", topic_ids: [], contributor_ids: [], chapters: [], content_media: [] });
...
export default function AdminWorkspace() {
  ...
  function startNew() {
    ...
    else if (active === "news") setEditing({ title: "", title_ar: "", slug: "", summary: "", summary_ar: "", category_id: String(newsCategories[0]?.id ?? ""), status: "draft", published_at: new Date().toISOString().slice(0, 10), link_url: "", cover_media_path: "", pinned: false, related_type: "", related_ref: "", body: [{ key: "story", label: "The story", body: "" }], body_ar: [], news_media: [] });
