...
function List({ section, items, search, setSearch, topics, researchTopics, filters, setFilters, researchFilters, setResearchFilters, onEdit, onDelete }: { section: Section; items: RecordItem[]; search: string; setSearch: (value: string) => void; topics: RecordItem[]; researchTopics: RecordItem[]; filters: ContentFilters; setFilters: (filters: ContentFilters) => void; researchFilters: ResearchFilters; setResearchFilters: (filters: ResearchFilters) => void; onEdit: (item: RecordItem) => void; onDelete: (item: RecordItem) => void }) {
  ...
  return <div className="admin-list">
    ...
    {section === "content" ? <div className="admin-content-filters">
      <FilterSelect className="admin-filter-select" label="Topic" value={filters.major} onChange={(value) => change("major", value)} options={[{ value: "", label: "All topics" }, ...majors.map((topic) => ({ value: String(topic.id), label: String(topic.name) }))]} />
      <FilterSelect className="admin-filter-select" label="Subtopic" value={filters.subtopic} disabled={!filters.major} onChange={(value) => change("subtopic", value)} options={[{ value: "", label: "All subtopics" }, ...subtopics.map((topic) => ({ value: String(topic.id), label: String(topic.name) }))]} />
      <FilterSelect className="admin-filter-select" label="Status" value={filters.status} onChange={(value) => change("status", value)} options={[{ value: "", label: "All statuses" }, { value: "published", label: "Published" }, { value: "draft", label: "Draft" }, { value: "scheduled", label: "Scheduled" }, { value: "archived", label: "Archived" }]} />
      <FilterSelect className="admin-filter-select" label="Access" value={filters.access} onChange={(value) => change("access", value)} options={[{ value: "", label: "All access" }, { value: "public", label: "Public" }, { value: "members_only", label: "Members only" }]} />
      ...
      <FilterSelect className="admin-filter-select" label="Order" value={filters.sort} onChange={(value) => change("sort", value)} options={[{ value: "published_desc", label: "Newest published" }, { value: "published_asc", label: "Oldest published" }, { value: "updated_desc", label: "Recently updated" }]} />
    ...
    {section === "research" ? <div className="admin-content-filters">
      <FilterSelect className="admin-filter-select" label="Year" value={researchFilters.year} onChange={(value) => setResearchFilters({ ...researchFilters, year: value })} options={[{ value: "", label: "All years" }, ...researchYears.map((year) => ({ value: year, label: year }))]} />
      <FilterSelect className="admin-filter-select" label="Topic" value={researchFilters.topic} onChange={(value) => setResearchFilters({ ...researchFilters, topic: value })} options={[{ value: "", label: "All topics" }, ...researchMajors.map((topic) => ({ value: String(topic.id), label: String(topic.name) }))]} />
      <FilterSelect className="admin-filter-select" label="Status" value={researchFilters.status} onChange={(value) => setResearchFilters({ ...researchFilters, status: value })} options={[{ value: "", label: "All statuses" }, { value: "published", label: "Published" }, { value: "draft", label: "Draft" }, { value: "archived", label: "Archived" }]} />
